...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OgreWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OgreWidget_t qt_meta_stringdata_OgreWidget = {
    {
QT_MOC_LITERAL(0, 0, 10) // "OgreWidget"
...
QT_INIT_METAOBJECT const QMetaObject OgreWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_OgreWidget.data,
    qt_meta_data_OgreWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *OgreWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OgreWidget.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "ScapeEngine::InputListener"))
        return static_cast< ScapeEngine::InputListener*>(this);
