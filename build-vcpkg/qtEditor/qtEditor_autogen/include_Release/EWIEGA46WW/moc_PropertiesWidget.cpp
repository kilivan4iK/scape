...
#include <memory>
#include "../../../../../qtEditor/PropertiesWidget.h"
...
QT_MOC_LITERAL(1, 17, 20), // "propertyValueChanged"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 11), // "std::string"
QT_MOC_LITERAL(4, 51, 3), // "key"
QT_MOC_LITERAL(5, 55, 5), // "value"
QT_MOC_LITERAL(6, 61, 11), // "itemChanged"
QT_MOC_LITERAL(7, 73, 14), // "QStandardItem*"
QT_MOC_LITERAL(8, 88, 4) // "item"

    },
    "PropertiesWidget\0propertyValueChanged\0"
    "\0std::string\0key\0value\0itemChanged\0"
    "QStandardItem*\0item"
};
...
void PropertiesWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->propertyValueChanged((*reinterpret_cast< const std::string(*)>(_a[1])),(*reinterpret_cast< const std::string(*)>(_a[2]))); break;
        case 1: _t->itemChanged((*reinterpret_cast< QStandardItem*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PropertiesWidget::*)(const std::string & , const std::string & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PropertiesWidget::propertyValueChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PropertiesWidget::propertyValueChanged(const std::string & _t1, const std::string & _t2)
{
